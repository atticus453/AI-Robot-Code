...
////topic ////////////////////////////////////////////////////
    ...
    ros::Publisher pub_pos = node.advertise<arm_control::PosCmd>("/puppet/pose_left", 10);
...
////topic ////////////////////////////////////////////////////
        ...
        if(ARX_ARM.current_vel[6]<2)
        {
            // msg_joint01.effort[6]=-ARX_ARM.Data_process(ARX_ARM.current_torque[6]); 
        }
        else
        {
            msg_joint01.effort[6]=0; 
        }
